...
<html lang="en">
	...
	<header class="shadow-md bg-white font-[sans-serif] tracking-wide relative z-50">
				...
				<div id="collapseMenu" class="max-lg:hidden lg:!block max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-40 max-lg:before:inset-0 max-lg:before:z-50">
					...
					<ul
						...
						<li class="max-lg:border-b max-lg:px-3 max-lg:py-3">
							<a href="/" class="hover:text-teal-600 text-gray-800 block text-[15px]">Home</a>
						</li>

						<li class="max-lg:border-b max-lg:px-3 max-lg:py-3">
							<a href="about" class="hover:text-teal-600 text-gray-800 text-[15px] block">Tentang Kami</a>
						</li>

						<li class="max-lg:border-b max-lg:px-3 max-lg:py-3">
							<a href="product" class="hover:text-teal-600 text-gray-800 text-[15px] block">Produk</a>
						</li>

						<li class="group max-lg:border-b max-lg:px-3 max-lg:py-3 relative">
							<a href="activity" class="hover:text-teal-600 hover:fill-teal-600 text-teal-600 font-semibold text-[15px] flex items-center"
								>Aktivitas Kami<svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" class="ml-1 inline-block" viewBox="0 0 24 24">
							...
							<ul
								...
								<li>
									<a href="javascript:void(0)" class="hover:text-teal-600 hover:fill-teal-600 text-gray-800 text-[15px] flex items-center"> dummy1 </a>
								</li>
								<li>
									<a href="javascript:void(0)" class="hover:text-teal-600 hover:fill-teal-600 text-gray-800 text-[15px] flex items-center"> dummy2 </a>
								</li>
							</ul>
						</li>

						<li class="group max-lg:border-b max-lg:px-3 max-lg:py-3 relative">
							<a href="article" class="hover:text-teal-600 hover:fill-teal-600 text-gray-800 text-[15px] flex items-center"
								>Artikel<svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" class="ml-1 inline-block" viewBox="0 0 24 24">
									<path d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z" data-name="16" data-original="#000000" />
								</svg>
							</a>
							<ul
						...
						<li class="max-lg:border-b max-lg:px-3 max-lg:py-3">
							<a href="contact" class="hover:text-teal-600 text-gray-800 text-[15px] block">Kontak Kami</a>
						</li>

						<li class="group max-lg:border-b max-lg:px-3 max-lg:py-3 relative">
							<a href="javascript:void(0)" class="hover:text-teal-600 hover:fill-teal-600 text-gray-800 text-[15px] flex items-center"
								>Bahasa<svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" class="ml-1 inline-block" viewBox="0 0 24 24">
									<path d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z" data-name="16" data-original="#000000" />
								</svg>
							</a>
							<ul
								class="absolute top-5 max-lg:top-8 left-0 z-50 block space-y-2 shadow-lg bg-white max-h-0 overflow-hidden min-w-[230px] group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-[400ms]">
								<li>
									<a href="javascript:void(0)" class="hover:text-teal-600 hover:fill-teal-600 text-gray-800 text-[15px] flex items-center"> Indonesia </a>
								</li>
								<li>
									<a href="javascript:void(0)" class="hover:text-teal-600 hover:fill-teal-600 text-gray-800 text-[15px] flex items-center"> English </a>
								</li>
							</ul>
						</li>
					</ul>
		...
		<span class="relative flex justify-center mt-4">
			...
			<span class="relative z-10 bg-slate-100 px-6 text-2xl rounded-t-2xl">Detail Activity</span>
		</span>
		<h3 class="p-4 bg-slate-100 text-sm text-center mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus, quidem!</h3>
			...
			<div class="flex flex-row justify-center gap-16">
				<div class="block w-fit">
					<div class="flex flex-col bg-white p-2 rounded-2xl w-196">
						<img class="h-196" src="https://images.unsplash.com/photo-1605721911519-3dfeb3be25e7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="" />
						<div class="flex flex-col gap-2 p-2">
							<h1 class="text-xl font-bold">Ini aktivitas yang ada catnya</h1>
							<div class="flex flex-row gap-4">
								<p class="text-sm bg-blue-600 rounded-2xl px-2 text-white">Outdoor</p>
								<p class="text-sm text-slate-400">12 Feb 2023</p>
							</div>
							<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis quaerat itaque earum, voluptatibus consequuntur vero porro recusandae reiciendis delectus iste a ipsa ducimus voluptatem. Rem nulla eius nam eos fugiat perferendis autem voluptatem, voluptatibus, itaque magni necessitatibus, blanditiis illo ipsum.</p>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reprehenderit suscipit blanditiis quasi cum beatae ratione ullam rem quia assumenda sed!</p>
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vero, veritatis molestiae assumenda maxime aliquam ex cumque animi soluta quod velit mollitia esse omnis saepe nostrum architecto ipsa hic? Inventore nihil voluptate nobis non maiores quo vero, neque animi, eos natus repudiandae atque vel fugit quasi expedita, sint voluptatibus! Repellendus, aperiam.</p>
						</div>
					</div>
				</div>
				<div class="block w-sm">
					<div class="flex flex-col gap-4">
						<a href="" class="flex flex-row gap-4 bg-white bg-auto rounded-2xl transition ease-in-out hover:bg-blue-200 p-4">
							<img class="h-[128px] rounded-2xl" src="https://images.unsplash.com/photo-1605721911519-3dfeb3be25e7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="" />
							<div class="flex flex-col gap-2 justify-center">
								<h1 class="font-bold text-sm">Activity 1</h1>
						...
						<a href="" class="flex flex-row gap-4 bg-white bg-auto rounded-2xl transition ease-in-out hover:bg-blue-200 p-4">
							<img class="h-[128px] rounded-2xl" src="https://images.unsplash.com/photo-1605721911519-3dfeb3be25e7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="" />
							<div class="flex flex-col gap-2 justify-center">
								<h1 class="font-bold text-sm">Activity 2</h1>
								<p class="text-sm text-slate-400">08 Feb 2023</p>
							</div>
						</a>
						<a href="" class="flex flex-row gap-4 bg-white bg-auto rounded-2xl transition ease-in-out hover:bg-blue-200 p-4">
							<img class="h-[128px] rounded-2xl" src="https://images.unsplash.com/photo-1605721911519-3dfeb3be25e7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="" />
							<div class="flex flex-col gap-2 justify-center">
								<h1 class="font-bold text-sm">Activity 3</h1>
								<p class="text-sm text-slate-400">08 Feb 2023</p>
							</div>
						</a>
						<a href="" class="flex flex-row gap-4 bg-white bg-auto rounded-2xl transition ease-in-out hover:bg-blue-200 p-4">
							<img class="h-[128px] rounded-2xl" src="https://images.unsplash.com/photo-1605721911519-3dfeb3be25e7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="" />
							<div class="flex flex-col gap-2 justify-center">
								<h1 class="font-bold text-sm">Activity 4</h1>
								<p class="text-sm text-slate-400">08 Feb 2023</p>
							</div>
						</a>
					</div>
			...
			<div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
				<div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
					...
					<div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
						<span></span>
						<div>
							<p class="font-medium text-gray-900">Link Penting</p>
						...
						<div>
							<p class="font-medium text-gray-900">Marketplace</p>

							<ul class="mt-6 space-y-4 text-sm">
								<li>
									<a href="product.html" class="text-gray-700 transition hover:opacity-75"> Shopee </a>
								</li>

								<li>
									<a href="article.html" class="text-gray-700 transition hover:opacity-75"> Tokopedia </a>
								</li>
							</ul>
						</div>

						<div>
							<p class="font-medium text-gray-900">Artikel</p>

							<ul class="mt-6 space-y-4 text-sm">
								<li>
									<a href="#" class="text-gray-700 transition hover:opacity-75"> lorem </a>
								</li>

								<li>
									<a href="#" class="text-gray-700 transition hover:opacity-75"> ipsum </a>
								</li>

								<li>
									<a href="#" class="text-gray-700 transition hover:opacity-75"> dolor </a>
								</li>
							</ul>
						</div>
					</div>
